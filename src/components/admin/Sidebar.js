  ...
  return (
    <aside id="sidebar" className={openSidebarToggle ? "sidebar-responsive": ""}>
        ...
        <ul className='sidebar-list'>
            ...
            <li onClick={()=>navigate('/admin-dashboard/add-product')} className='sidebar-list-item'>
                <span>
                    <BsFillArchiveFill className='icon'/>Add Products
                </span>
            </li>
            <li onClick={()=>navigate('/admin-dashboard/add-yoga')} className='sidebar-list-item'>
                <span>
                    <BsFillGrid3X3GapFill className='icon'/> Add Yoga
                </span>
            </li>
            <li className='sidebar-list-item'>
                <span>
